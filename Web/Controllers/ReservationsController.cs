...
namespace Web.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReservationId,ProjectionId,UserId")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReservationId,ProjectionId,UserId")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
